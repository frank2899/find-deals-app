            ...
            <CardBody>
                <Stack mt="6" spacing="2">
                    <Flex alignItems="center" justifyContent="center" height="150px" p="5px">
                        <Image src={details.image} alt={details.product} borderRadius="lg" height="150px" objectFit="cover" />
                    </Flex>
                    <Text fontSize="lg" color="gray">
                        {details.price}
                    </Text>
                    <Heading size="sm" color="#122167">
                        {details.product}
                    </Heading>
                    <Box>
                        <Text fontSize="sm" color="dark" mb="5px">
                            {details.otherDetails[0]}
                        </Text>
                        {details.otherDetails.length > 1 ? (
